...
const Dashboard: FC = () => {
  ...
  const navItems = [
    ...
    { icon: "🔒", label: "Practice (Locked)", active: false },
    {
      icon: "🎯",
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <aside
        className={`${sidebarOpen ? "w-64" : "w-20"} bg-white border-r border-gray-200 flex flex-col transition-all duration-300 fixed h-full z-20`}
      >
        {/* Logo */}
        ...
        <nav className="flex-1 p-4">
          <p
            className={`text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4 ${!sidebarOpen && "text-center"}`}
          >
        ...
        <div className="p-8">
          ...
          <div className="relative rounded-2xl overflow-hidden mb-8">
            ...
            <div className="relative px-8 py-10 md:px-12">
              <p className="text-cyan-100 text-sm font-medium tracking-wider uppercase mb-2">
                Welcome Back
              </p>
              ...
              <button
                disabled
                aria-label="Practice mode is currently unavailable"
                className="inline-flex items-center gap-2 bg-white/90 text-blue-700 font-semibold px-6 py-3 rounded-xl cursor-not-allowed opacity-95 border border-white/40"
              >
                🔒 Practice Locked
              </button>
              <p className="mt-3 text-sm text-blue-100 font-medium">
                Practice mode is not available right now.
              </p>
            </div>
          </div>
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span
                    className={`inline-flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br ${stat.color} text-white text-lg`}
                  >
                    {stat.icon}
                  </span>
                  <svg
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-white/95 rounded-2xl p-6 border-2 border-dashed border-gray-200 shadow-sm transition-all group relative">
                  <span className="absolute top-4 right-4 px-2.5 py-1 rounded-full bg-gray-900 text-white text-[10px] font-bold tracking-wide uppercase">
                    Locked
                  </span>
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 border border-gray-300 flex items-center justify-center text-2xl">
                      🔒
                    </div>
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Practice mode is temporarily unavailable. It will be enabled
                    in an upcoming update.
                  </p>
                  <button
                    disabled
                    aria-label="Practice mode is currently unavailable"
                    className="w-full py-3 bg-gray-200 text-gray-600 font-semibold rounded-xl cursor-not-allowed"
                  >
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-all group">
                  ...
                  <p className="text-gray-600 text-sm mb-4">
                    Experience a complete timed mock interview with 5 questions.
                  </p>
                  <button
                    onClick={() => navigate("/mock-interview")}
                    ...
                    {attempts.slice(0, 5).map((attempt) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-semibold flex-shrink-0 ml-3 ${
                              attempt.is_correct
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl p-6 text-white">
                ...
                <p className="text-blue-100 text-sm leading-relaxed">
                  Practice speaking your answers out loud. This helps with
                  articulation and builds confidence for real interviews.
                </p>
              </div>
                  ...
                  <div>
                    ...
                    <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${Math.min((stats.todayAttempts / 10) * 100, 100)}%`,
                        }}
                      />
                    </div>
                  </div>
