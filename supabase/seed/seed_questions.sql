-- =============================================================================
-- Interview Preparation SaaS - Seed Questions
-- Run this after initial migration to populate sample questions
-- =============================================================================

INSERT INTO questions (title, question_text, category, topic, difficulty, ideal_answer, rubric, tags, estimated_time_minutes)
VALUES 
(
  'JavaScript Closures',
  'Explain what closures are in JavaScript. How do they work, and provide a practical example where closures are useful?',
  'frontend',
  'JavaScript Fundamentals',
  'medium',
  E'A closure is a function that has access to variables from its outer (enclosing) function''s scope, even after the outer function has returned. This happens because the inner function maintains a reference to the outer function''s variable environment.\n\nHow it works:\n1. When a function is created, it captures a reference to its lexical environment\n2. This environment includes all local variables that were in-scope at the time the closure was created\n3. The closure ''closes over'' these variables, keeping them alive even after the outer function completes\n\nPractical example - Data Privacy/Encapsulation:\n```javascript\nfunction createCounter() {\n  let count = 0; // private variable\n  return {\n    increment: function() { return ++count; },\n    decrement: function() { return --count; },\n    getCount: function() { return count; }\n  };\n}\n\nconst counter = createCounter();\ncounter.increment(); // 1\ncounter.increment(); // 2\ncounter.getCount(); // 2\n// count is not accessible directly\n```\n\nOther use cases include:\n- Partial application and currying\n- Event handlers that need access to outer variables\n- Module pattern for encapsulation\n- Memoization and caching',
  '{
    "concept_accuracy": {
      "max_score": 4,
    ...
    "clarity": {
      "max_score": 1,
      "weight_description": "Clear, well-structured explanation that is easy to follow",
      "scoring_guide": [
...
(
  ...
  ARRAY['database', 'indexing', 'optimization', 'sql'],
  8
);

-- Verify insertion
SELECT id, title, category, difficulty FROM questions;
